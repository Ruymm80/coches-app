            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center gap-2 pl-1 pr-3 py-1 border border-transparent text-sm leading-4 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
                                @if(Auth::user()->avatarUrl())
                                    <img src="{{ Auth::user()->avatarUrl() }}" alt="Foto de perfil"

@php
    ...
    $val = fn ($k, $default = '') => old($k, data_get($coche, $k) instanceof \BackedEnum ? data_get($coche, $k)->value : data_get($coche, $k, $default));
@endphp
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
            ...
            @if(isset($coche) && $coche->exists && $coche->imagenes->count())
                <div class="grid grid-cols-3 sm:grid-cols-4 gap-3">
                    @foreach($coche->imagenes as $img)
